...
class iconColor {
  ...
  static const green = Color.fromARGB(255, 127, 189, 91);
}

class buttonColor {
  static const yellow = Color.fromARGB(255, 254, 207, 0);
}

class frontColor {
  static const black = Color.fromARGB(255, 60, 60, 60);
}

class approveColor {
  static const purple = Color.fromARGB(255, 177, 130, 191);
  static const blue = Color.fromARGB(255, 123, 181, 232);
  static const pink = Color.fromARGB(255, 251, 126, 141);
}
